...
import fiveGuysPlanYourDateNight from '../../images/fiveGuysPlanYourDateNight.JPG';
import playTimeOver from '../../images/playTimeOver.JPG';
import readyPetGo from '../../images/readyPetGo.JPG';
      ...
      <div id="portfolioContainer" className="container-fluid mb-5"   >
        ...
        <div className="container">
          ...
          <div>
            ...
            <p className="myFont">
              What you're here to see I bet! Thank you for giving this a check! This is every assignment I completed during the full-stack web development bootcamp. If the assignment could be posted on Github/Heroku, then the title will be highlighted for you to checkout. If not, all the pictures will have a 'pop-up' with the grade I received for it as well as the grader's comments on my application. Then lastly, a few worthwhile mentions from the bootcamp I am particularly proud of:
              <br />
              <i>
              Final Grade: 95.92 <br />
                Peer Awards:  <br />
                <ul>
     
                <li>  "Back-End Specialist"</li>  
              <li> "Always Has Can-Do Attitude"</li>
                </ul>
              </i>
            </p>
        ...
        <div className={`container-fluid  mt-3 justify-content-center d-flex flex-wrap `} >
          <h2>The Projects</h2>
          <p className="fs-6 text-center">Click on the <i>title</i> to visit the website or click on the <i>image</i> to see my thoughts/contributions and grader feedback if applicable. </p>
        </div>
          ...
          <div className="d-flex mt-5 flex-wrap justify-content-around gap-5" >
            ...
            <div className="text-center" >
              ...
              <div className="cardContainer1">
                <img onClick={() => handleModalOpen('modal1')} src={fiveGuysPlanYourDateNight} className="card-img-top" alt="..."></img>
            ...
            <div className="text-center" >
              ...
              <div className="cardContainer1">
                <img onClick={() => handleModalOpen('modal2')} src={playTimeOver} className="card-img-top" alt="..."></img>
                <div className="card-body">
            ...
            <div className="text-center" >
              ...
              <div className="cardContainer1">
                <img onClick={() => handleModalOpen('modal3')} src={readyPetGo} className="card-img-top" alt="..."></img>
                <div className="card-body">
                  <p className="card-text">My final group project; a combination of a social network and ecommerce website all tailored to fit the needs of new and experienced pet owners alike.</p>
                </div>
              </div>
            </div>
          ...
          <div className="d-flex mt-5 flex-wrap justify-content-around gap-5" >
            ...
            <div className="text-center" >
              <a style={{ textDecoration: 'none' }} href="https://finaltexteditor.herokuapp.com/"><h5>
                Challenge19: (PWA): Text Editor </h5></a>
